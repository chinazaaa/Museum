...
const HomePage = () => {
  ...
  const [images, setImage] = useState({
    image:[{id: 1, data: "https://p.bigstockphoto.com/GeFvQkBbSLaMdpKXF1Zv_bigstock-Aerial-View-Of-Blue-Lakes-And--227291596.jpg"}, {id: 2, data: 'https://p.bigstockphoto.com/GeFvQkBbSLaMdpKXF1Zv_bigstock-Aerial-View-Of-Blue-Lakes-And--227291596.jpg'}]
  })

  return (
    <Fragment>
     {images.image.map(single => (
      <img src={single.data} alt="image" />
     ))}
    </Fragment>
  )
}
